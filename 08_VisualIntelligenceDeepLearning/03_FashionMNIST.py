...
Conv1 = tf.keras.layers.Conv2D(32, (3, 3), padding='same', activation='swish')(input_layer)
BatchNorm1 = tf.keras.layers.BatchNormalization()(Conv1)

Conv2 = tf.keras.layers.Conv2D(32, (3, 3), padding='same', activation='swish')(BatchNorm1)
BatchNorm2 = tf.keras.layers.BatchNormalization()(Conv2)

MaxPool = tf.keras.layers.MaxPooling2D(pool_size=(2, 2), strides=(2, 2))(BatchNorm2)
DropOut = tf.keras.layers.Dropout(0.25)(MaxPool)
FlattenLayer = tf.keras.layers.Flatten()(DropOut)

Dense1 = tf.keras.layers.Dense(512, activation='swish')(FlattenLayer) # Fully Connected Layer
